        ...
        <nav class="row text-primary d-flex justify-content-between align-items-center  " role="footer navigation">
          <div class="col-lg-3 col-md-4 col-12  ">
            ...
            <ul class="list-unstyled text-center text-secondary  mt-4 ">
              <li class="d-inline m-2 "><a class="text-decoration-none socialLinks text-secondary " href="https://www.facebook.com/kenz.atla?sfnsn=wa&mibextid=RUbZ1f" title="Visiter la page Facebook de KenzAtlas "><i class="fa-brands fa-facebook fa-lg"></i></a></li>
              <li class="d-inline m-2 "><a class="text-decoration-none socialLinks text-secondary " href="https://www.instagram.com/kenz.atlas?igsh=MTg2bWVoYjEzbzBhag==" title="Visiter la page Instagram de KenzAtlas "><i class="fa-brands fa-instagram fa-lg"></i></a></li>
              <li class="d-inline m-2"><a class="text-decoration-none socialLinks text-secondary " href="https://www.tiktok.com/@kenzatlaspro?_t=8jMB8zQPPWf&_r=1" title="Visiter la page TikTok de KenzAtlas "><i class="fa-brands fa-tiktok fa-lg"></i></a></li>
              <li class="d-inline m-2"><a class="text-decoration-none socialLinks text-secondary " href="https://wa.me/+212684822768" title="Ouvrir un chat whatssap avec KenzAtlas "><i class="fa-brands fa-whatsapp fa-lg"></i></a></li>
            </ul>
          </div>
